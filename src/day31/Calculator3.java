...
public class Calculator3 {
		  ...
		  public static void calculate(char operator,int firstNum, int secNum) {
			    ...
			    case '+':
			      ...
			      break;
			    case '-':
			      System.out.println("result of subrtraction is : " + (firstNum-secNum));
			      break;
			    case '*':
			      System.out.println("result of multiplication is : " + (firstNum*secNum));
			      break;
			    case '/':
			      System.out.println("result of dividion is : " + (firstNum/secNum));
			      break;
			    case '%':
			      System.out.println("result of remainder is : " + (firstNum%secNum));
			      break;
