package day37;
import java.util.*;  // bu hepsini icerir !!  tek bunu import etsen yeterli
...
public class ArrayListPractice {
	...
	//array list demek array a ait liste. list too general
	//	elekronik degil de computer demek gibi
		...
		//import java.util.List;
		    ...
		    System.out.println(  "item 1 : " + lst1.get(0) ) ; //yasar
		    System.out.println(  "item 2 : " + lst1.get(1) ) ; 
		    System.out.println(  "item 3 : " + lst1.get(2) ) ; 
		    System.out.println(  "item 4 : " + lst1.get(3) ) ; 
		    System.out.println(  "item 5 : " + lst1.get(4) ) ; //Emine
		    System.out.println(  "item 5 : " + lst1.get(3));
		    
		    String str = lst1.get(5);   // u can store as well
		    System.out.println(  "item 6 : " + str ) ; 
		  
		    // getting the count of the items inside 
		    // we use size() method 
		    int count = lst1.size(); 
		    lst1.size();lst1.size();lst1.size();
		    lst1.size();lst1.size();
		    lst1.size(); lst1.size();
		    lst1.size();
		    lst1.size();
		    int countt = lst1.size();
